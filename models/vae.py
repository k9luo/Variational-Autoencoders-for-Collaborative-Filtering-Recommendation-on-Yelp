...
def vae_cf(matrix_train, epoch=100, lamb=80, rank=200, corruption=0.5, optimizer="RMSProp", **unused):
    progress = WorkSplitter()

    m, n = matrix_train.shape
    model = VAE(n, rank, 100, lamb=lamb, observation_distribution="Multinomial", optimizer=Regularizer[optimizer])
